  ...
  return (
    <div className="about">
      ...
      <div className="text_container">
        ...
        <div className="aboutText">In the dynamic world of full-stack development, I specialize in creating seamless & fully-responsive websites using Python, Java, JavaScript, TypeScript, React, Node.js, CSS, and HTML.</div>
